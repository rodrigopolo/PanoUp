<?php
// gpano_math.php — canonical GPano orientation math.
// Ported from gpano-viewer-translation-layer.md's reference implementation:
// real 3x3 rotation-matrix composition (not scalar addition), used to turn
// a file's world-frame Pose + InitialView into a viewer's local (pano-
// relative) yaw/pitch/roll. Vectors are [x,y,z] arrays; matrices are 3
// arrays of 3 floats (row-major).
...
// the pano's own untouched pixel-grid frame. This is what feeds any viewer
// that lacks native GPano coupling (i.e. all of Pannellum/Marzipano/krpano,
// once driven manually instead of relying on a viewer's own XMP parsing).
//
